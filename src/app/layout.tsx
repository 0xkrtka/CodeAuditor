...
export const metadata: Metadata = {
  title:       "CodeAuditor — On-chain AI Smart Contract Security | Ritual Chain",
  ...
  openGraph: {
    title:       "CodeAuditor on Ritual Chain",
  ...
  twitter: {
    ...
    title:       "CodeAuditor — On-chain AI Smart Contract Security",
